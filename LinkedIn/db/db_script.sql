...
-- Πεμ 19 Απρ 2018 09:10:11 μμ EEST
...
CREATE TABLE IF NOT EXISTS `linkedin_db`.`connection` (
  `userID_1` MEDIUMTEXT NOT NULL,
  `userID_2` MEDIUMTEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `linkedin_db`.`message` (
  ...
  `senderID` MEDIUMTEXT NOT NULL,
  `receiverID` MEDIUMTEXT NOT NULL,
  `text` VARCHAR(1024) NOT NULL,
