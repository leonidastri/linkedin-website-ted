	                                ...
	                                <tbody>
										<c:if test="${jobs.size() != 0}">
	                                    	...
	                                    	<c:if test="${jobs.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=jobs" role="button">Show all jobs</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${jobs.size() == 0}">
											<tr>
	                                ...
	                                <tbody>                                
	                                    <c:if test="${education.size() != 0}">
	                                    	...
	                                    	<c:if test="${education.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=education" role="button">Show all education</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${education.size() == 0}">
											<tr>
	                                ...
	                                <tbody>                                    
	                                    <c:if test="${skills.size() != 0}">
	                                    	...
	                                    	<c:if test="${skills.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=skills" role="button">Show all skills</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${skills.size() == 0}">
											<tr>
	                                ...
	                                <tbody>                                    
	                                    <c:if test="${articles.size() != 0}">
	                                    	...
	                                    	<c:if test="${articles.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=articles" role="button">Show all articles</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${articles.size() == 0}">
											<tr>
	                                ...
	                                <tbody>                                  
	                                    <c:if test="${listings.size() != 0}">
	                                    	...
	                                    	<c:if test="${listings.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=listings" role="button">Show all listings</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${listings.size() == 0}">
											<tr>
	                                ...
	                                <tbody>
	                                    <c:if test="${comments.size() != 0}">
	                                    	...
	                                    	<c:if test="${comments.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=comments" role="button">Show all comments</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${comments.size() == 0}">
											<tr>
	                                ...
	                                <tbody>
	                                    <c:if test="${likedArticlesDetails.size() != 0}">
	                                    	...
	                                    	<c:if test="${likedArticlesDetails.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=liked_articles" role="button">Show all liked articles</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${likedArticlesDetails.size() == 0}">
											<tr>
	                                ...
	                                <tbody>
	                                   <c:if test="${likedListingsDetails.size() != 0}">
	                                    	...
	                                    	<c:if test="${likedListingsDetails.size() > 3}">
		                                    	...
		                                    	<!-- TODO -->
		                                    	<a class="btn btn-primary" href="UserProfileShowAll?action=liked_listings" role="button">Show all liked listings</a>
	                                    	</c:if>
										</c:if>
										<c:if test="${likedListingsDetails.size() == 0}">
											<tr>
